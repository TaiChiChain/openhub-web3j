...
public class JsonRpc2_0Web3j implements Web3j {
    ...
    @Override
    public Request<?, AxiomStatus> status() {
        return new Request<>(
                "axm_status", Collections.<String>emptyList(), web3jService, AxiomStatus.class);
    }

    @Override
    public Request<?, AXMIncentiveAddrResponse> getIncentiveAddr() {
        return new Request<>(
                "axm_getIncentiveAddress",
                Collections.<String>emptyList(),
                web3jService,
                AXMIncentiveAddrResponse.class);
    }
}
